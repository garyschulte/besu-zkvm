...
/**
 * Test case for Gnark BLS12-381 G2 point validation operations. Tests if a valid G2 point is
 * correctly identified as being on the curve. This exercises Gnark's native cryptographic
...
public class GnarkG2PointTest {
  ...
  public static void runTest() {
    ...
    boolean result =
        LibGnarkEIP2537Graal.eip2537G2IsOnCurve(
