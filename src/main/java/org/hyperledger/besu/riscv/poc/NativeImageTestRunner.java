...
/**
 * Main test runner for GraalVM native-image test cases.
 * Provides a command-line interface to run various tests that exercise
 * native-image corner cases with different libraries.
 */
