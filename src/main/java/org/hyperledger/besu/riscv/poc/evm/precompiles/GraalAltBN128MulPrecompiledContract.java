...
/**
 * GraalVM-compatible AltBN128 scalar multiplication precompiled contract (Byzantium version).
 *
 * <p>This implementation uses LibGnarkEIP196Graal for native execution compatible with GraalVM
 * native image compilation.
 */
public class GraalAltBN128MulPrecompiledContract extends AbstractPrecompiledContract {

  private static final Logger LOG =
      LoggerFactory.getLogger(GraalAltBN128MulPrecompiledContract.class);

  private static final int PARAMETER_LENGTH = 96;
  private static final long GAS_COST = 40_000L; // Byzantium cost
  private static final Bytes POINT_AT_INFINITY = Bytes.repeat((byte) 0, 64);

  /**
   * Instantiates a new Graal AltBN128 Mul precompiled contract.
   *
   * @param gasCalculator the gas calculator
   */
  public GraalAltBN128MulPrecompiledContract(final GasCalculator gasCalculator) {
  ...
  public PrecompileContractResult computePrecompile(
    ...
    // Early return for point at infinity
    ...
    try (PinnedObject pinnedInput = PinnedObject.create(inputBytes);
      ...
      final int errorNo =
          LibGnarkEIP196Graal.eip196altbn128G1MulNative(
      ...
      if (errorNo == 0) {
        ...
        LOG.trace("Error executing AltBN128 Mul precompile: '{}'", errorString);
