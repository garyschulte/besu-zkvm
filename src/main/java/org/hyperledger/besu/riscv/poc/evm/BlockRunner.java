...
public class BlockRunner {
  ...
  private final org.hyperledger.besu.ethereum.trie.pathbased.bonsai.BonsaiWorldStateProvider
      worldStateArchive;
  ...
  public static BlockRunner create(
    ...
    EvmConfiguration evmConfiguration =
        new EvmConfiguration(32_000L, EvmConfiguration.WorldUpdaterMode.JOURNALED, false);
